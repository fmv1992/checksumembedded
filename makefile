...
export REFERENCE_DIR ?= $(ROOT_DIR)/checksumembedded

export PROJECT ?= checksumembedded_test
...
ENTRYPOINT := ./checksumembedded/usr/local/bin/checksumembedded
LIB := ./checksumembedded/usr/local/lib/checksumembedded/checksumembedded
...
# This is actually triggered by `package`, and it seems to be automatic.
install:
ifeq ($(IS_PACKAGING), true)
	cptar $(REFERENCE_DIR) / || true
else
	sudo apt install --yes ./output/deb/checksumembedded*.deb
endif
...
readme.md: readme.md.jinja docs/manpage.md.clean
	jinja \
        ...
        -- \
    $< \
        | gawk --file <(printf '' | base64 --decode) \
        | sponge $@
